...
export const api = {
  ...
  adminDeleteShopkeeper: (token, id) => request(`/api/wholesale/shopkeepers/${id}`, { method: 'DELETE', token }),
  adminRecordShopkeeperPayment: (token, id, payload) => request(`/api/wholesale/shopkeepers/${id}/payments`, { method: 'POST', body: payload, token }),
